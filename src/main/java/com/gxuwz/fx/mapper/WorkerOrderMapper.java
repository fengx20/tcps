...
public interface WorkerOrderMapper {
	 ...
	 * @return
	 */
	public int updateStatus(String phonenum, String keyid);
	 ...
	 * @return
	 */
	public List<WorkerOrder> getallqqd();

	/**
	 * 2获取所有指派单
	 * @return
	 */
	public List<WorkerOrder> getallzpd();

	/**
	 * 3获取一个订单信息
	 * @return
	 */
	public List<WorkerOrder> cxoneorder(String keyid);
